              ...
              {socialLinks.map((social) => {
                ...
                return (
                  <a
                    ...
                    className="w-10 h-10 flex items-center justify-center rounded-lg glass-effect hover:bg-white/10 transition-colors"
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start space-x-3">
                ...
                <a href="mailto:info@estate.com" className="text-gray-400 hover:text-white text-sm transition-colors">
                  info@estate.com
                </a>
              </li>
              <li className="flex items-start space-x-3">
          ...
          <div>
            ...
            <form className="space-y-3">
              <input
                ...
                className="w-full px-4 py-2 rounded-lg glass-effect border border-white/10 text-white placeholder-gray-500 focus:outline-none focus:border-blue-500 transition-colors"
              />
              <button
                type="submit"
